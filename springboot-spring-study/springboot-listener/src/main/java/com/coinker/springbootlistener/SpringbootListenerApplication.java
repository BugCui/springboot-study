package com.coinker.springbootlistener;

import com.coinker.springbootlistener.listener.demo1.EmailService;
import com.coinker.springbootlistener.listener.demo2.MySpringContextListener;
import com.coinker.springbootlistener.listener.demo2.MySpringContextListener2;
import com.coinker.springbootlistener.listener.demo3.BlockedListNotifier2;
...
public class SpringbootListenerApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SpringbootListenerApplication.class);
